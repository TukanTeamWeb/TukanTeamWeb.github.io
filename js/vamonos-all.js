...
(function() {
  ...
  ResultProperty = (function() {
    ...
    ResultProperty.description = "The `ResultProperty` allows you to check upon entering DisplayMode that " + "a variable has some arbitrary property, and set the html of a container accordingly.";
    ...
    ResultProperty.prototype.event = function() {
      ...
      switch (event) {
        ...
        case 'displayStart':
          ...
          console.log(view);
          if (this.test(view[this.varName])) {
            return this.container.html(this.success);
          } else {
            return this.container.html(this.failure);
          }
      }
    };
